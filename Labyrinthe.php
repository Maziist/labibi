...
// Fonction pour trouver une position aléatoire pour la souris
...
// Fonction pour trouver une position aléatoire pour le chat
...
// Fonction pour obtenir les voisins d'un point dans le labyrinthe
...
// Fonction heuristique pour la fuite de la souris
function fleeHeuristic($point, $catPosition) {
    return -calculateDistance($point, $catPosition);
}
// Algorithme A* inversé pour la fuite de la souris
...
// Fonction pour reconstruire le chemin trouvé par A*
...
// Fonction pour mettre à jour le brouillard de guerre
...
// Gestion du changement de type de labyrinthe
...
// Initialisation d'une nouvelle partie si nécessaire
if (!isset($_SESSION['maze']) || !isset($_SESSION['mousePosition']) || !isset($_SESSION['gameWon'])) {
    ...
    // Vérification que toutes les variables de session nécessaires sont définies
...
// Vérification que le labyrinthe est correctement initialisé
...
// Utilisation des variables de session pour l'état actuel
$selectedMaze = $_SESSION['maze'];
$catPosition = $_SESSION['catPosition'];
$mousePosition = $_SESSION['mousePosition'];
$fogOfWar = $_SESSION['fogOfWar'];
